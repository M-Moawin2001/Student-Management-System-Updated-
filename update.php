...
mysqli_query($con, "update complainform SET  Name='$Name', FatherName='$FatherName',Faculty='$Faculty',complain='$complainbox' where Id = '$StudentId'");
  header("Location:showcomplain.php");
  echo"you are subcribe successfuly";
}
?>
...
function showAlert() {
    ...
    if (document.getElementById('btnsave').clicked) {
  ...
  <body>
    ...
    <section class="home-section">
      <div class="home-content">
        ...
        <span class="text">Update Complain Form</span>
        </div>
    ...
    <?php
  $query = $_GET['q'];
  $data = mysqli_query($con, "select * from complainform where id = '$query'");
  for($i= 0; $i<mysqli_num_rows($data); $i++){
    ...
    echo"<label>Student Name </label><br>
      <input type='text' name='Name' placeholder='Student Name'  value='$rows[0]'><br><br>

      <label>Student Id </label><br>
      <input type='text' name='StudentId'  placeholder='Student Id'  value='$rows[1]'><br><br>

      <label>Father Name </label><br>
      <input type='text' name='FatherName'  placeholder='Father Name'  value='$rows[2]'><br><br>
      
      <label>Faculty </label><br>
      <input type='text' name='Faculty'  placeholder='Faculty'  value='$rows[3]'><br><br>

      <label>Complain </label><br>
      <textarea  name='complainbox' rows='4' cols='50' placeholder='TEXT'>$rows[4]
</textarea><br><br>
