  ...
  <Form action="showmarks.php" method="post">
    ...
    <section class="home-section">
      <div class="home-content">
        ...
        <span class="text" align="center">Marks query</span>
      </div>
...
if(isset($_POST['bts'])){
  $search = $_POST['search'];
$data = mysqli_query($con, "select * from marksquery ");
for ($i=0; $i < mysqli_num_rows($data); $i++) { 
    ...
    <td><a href='marksdelete.php?StudentId=$rows[1]' onclick=\"return confirm('Are you sure you want to delete this record?');\">Delete</a></td>
