...
// php code for desktop chart
$complain= mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(*) as total from complainform"))['total'];
$campus= mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(*) as total from campuschange"))['total'];
$marks= mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(*) as total from marksquery"))['total'];
...
<div class="chart-box">
<canvas id="requestChart" width="600" height="400" ></canvas>
</div>
</div>
<script>
  ...
  new Chart(ctx, {
    type: 'pie',
    data: {
      labels: ['Complaints', 'Campus Change', 'Marks Query'],
      datasets: [{
