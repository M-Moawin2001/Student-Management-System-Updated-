...
.button-29:active {
  ...
  <body>
  <Form action="showcampuschange.php" method="post">
    ...
    <section class="home-section">
      <div class="home-content">
        ...
        <span class="text" align="center">Campus Change Request</span>
      </div>
...
if(isset($_POST['bts'])){
  $search = $_POST['search'];
$data = mysqli_query($con, "select * from campuschange ");
for ($i=0; $i < mysqli_num_rows($data); $i++) { 
    ...
    <td><a href='changedelete.php?StudentId=$rows[1]' onclick=\"return confirm('Are you sure you want to delete this record?');\">Delete</a></td>
