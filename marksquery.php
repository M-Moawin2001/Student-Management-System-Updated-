...
mysqli_query($con, "INSERT INTO marksquery VALUES('$Name','$StudentId','$cars','$Marks','$Remarks')");
...
.sidebar .profile-details .job{
  ...
  <body>
    ...
    <section class="home-section">
      <div class="home-content">
        ...
        <span class="text">Marks Query</span>
      </div>
      <div class="blued-3">
    <Form action="marksquery.php" method="post">
  ...
  <option value="Principle of Marketing">Principle of Marketing</option>
  <option value="Web II">Web II</option>
  <option value="English Writing Skills"> English Writing Skills</option>
</select><br><br>

<label>Marks Obtain </label><br>
      <input type="text" name="Marks" id="Marks" placeholder="Marks"><br><br>

      <label>Remarks </label><br>
      <textarea id="Remarks" name="Remarks" rows="4" cols="50" placeholder="TEXT">
</textarea><br><br>
