...
mysqli_query($con, "INSERT INTO complainform VALUES('$Name','$StudentId','$FatherName','$Faculty','$complainbox')");
  ...
  <body>
    ...
    <section class="home-section">
      <div class="home-content">
        ...
        <span class="text">Complain Form</span>
        </div>
    ...
    <div class="blued-3">
      ...
      <textarea  name="complainbox" rows="4" cols="50" placeholder="TEXT">
</textarea><br><br>
